    ...
    <div className="space-y-6">
      ...
      {trackingResult && (
        <Card className="p-4">
          ...
          <div className="w-full h-64 bg-gradient-to-br from-blue-50 to-green-50 rounded-lg border flex items-center justify-center relative">
            <div className="text-center">
              <div className="text-6xl mb-4">🗺️</div>
              <h5 className="font-semibold mb-2">Hyderabad, Telangana</h5>
              <p className="text-sm text-muted-foreground mb-4">
                Bus Location: {trackingResult.coordinates.lat}, {trackingResult.coordinates.lng}
              </p>
              <div className="flex items-center justify-center space-x-4">
                <div className="flex items-center">
                  <div className="w-3 h-3 bg-green-500 rounded-full mr-2"></div>
                  <span className="text-sm">Start: {trackingResult.startPoint}</span>
                </div>
                <div className="flex items-center">
                  <div className="w-3 h-3 bg-blue-500 rounded-full animate-pulse mr-2"></div>
                  <span className="text-sm">🚌 {trackingResult.busNumber}</span>
                </div>
                <div className="flex items-center">
                  <div className="w-3 h-3 bg-red-500 rounded-full mr-2"></div>
                  <span className="text-sm">End: {trackingResult.destination}</span>
                </div>
              </div>
            </div>
          </div>
...
export default FixedBusTracker;